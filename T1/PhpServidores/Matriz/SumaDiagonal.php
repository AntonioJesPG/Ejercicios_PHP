...
<html>
    ...
    <body>
        ...
        <?php
            ...
            //Suma diagonal (Solo cuenta para la suma las filas y columnas con el mismo índice)
            $sumaD = sumaDiagonal($matriz);
        ?>
            <p>La suma de la diagonal de la matris es: <?php  echo$sumaD;  ?></p>
            </p>

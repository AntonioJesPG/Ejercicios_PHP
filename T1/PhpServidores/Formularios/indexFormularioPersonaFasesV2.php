    ...
    <body>
        <?php
         ...
         <form name="input" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
             ...
             ?>
                <input type="hidden" name="aficion[]" value="<?php echo$valor ?>">
             <?php 
            }
                foreach($_POST["Estudios"] as $estudios =>  $est){

             ?>
                <input type="hidden" name="Estudios[]" value="<?php echo$est ?>">
             <?php 
                }
        ...
        <p>Edad: </p>
         ...
         <input type="submit" value="Enviar" name="enviarDos"/>
         </form>
        <?php
            }
            else{
